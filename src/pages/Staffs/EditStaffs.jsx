...
function EditStaffs({
    ...
    const [data, setData] = useState({
        ...
        staffBrand: staffData?.staffBrand || '',
        staffPrice: staffData?.staffPrice || '',
        staffCategory: staffData?.staffCategory || '',
        staffDiscount: staffData?.staffDiscount || '',
        staffDescription: staffData?.staffDescription || ''    
    });
    ...
    const handleSubmit = async(e)=>{
        ...
        const response = await fetch(`${summaryApi.updateStaff.url}/${staffData._id}`,{
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 w-full h-full z-10 flex justify-center items-center bg-pink-200 bg-opacity-50">
            ...
            {/* Displaying the productsImage full screen */}
            {
                openFullScreenImage && (
                    <div>
                        <DisplayImage
